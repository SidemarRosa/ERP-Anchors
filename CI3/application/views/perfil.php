...
<body class="g-sidenav-show bg-gray-100">
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item mt-3">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Conta pessoal</h6>
                </li>
                <li class="nav-item">
    ...
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        ...
        <div class="container-fluid">
            <div class="page-header min-height-300  mt-4" style="background-image: url('../assets/img/curved-images/curved0.jpg'); background-position-y: 50%;">
