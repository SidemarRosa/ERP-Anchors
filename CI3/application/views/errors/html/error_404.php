...
<body class="g-sidenav-show bg-gray-100">
	<aside
		...
		<div class="sidenav-header">
			...
			<a
				...
				href="dashboard.html">
				<span class="ms-1 font-weight-bold">Anchorstec ERP</span>
			</a>
		</div>
		...
		<div
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item max-height-100">
	...
	<main
		class="main-content position-relative max-height-vh-100 h-100 max-width-vw mt-1 border-radius-lg">
		<div class="row mt-1 m-0">
			<div class="col-lg-12 mb-lg-0 mb-4">
				<div class="card">
					<div class="card-body">
						<div class="row">
							<div class="col-lg-6 ms-auto text-center mt-lg-">
								<div class="d-flex flex-column h-100 mt-8">
									<p class="mb-1 fs-3 text-bold">OPS!!!</p>
									<h5 class="font-weight-bolder">Não encontramos a sua solicitação.</h5>
									<p class="mb-1 arrowCenter">
										Volte para a página inicial, e tentar novamente!
									</p>
									<a
										class="text-body text-sm font-weight-bold icon-move-right mt-5"
										href="dashboard.html">
							...
							<div class="col-lg-6 ms-auto text-center mt-5 mt-lg-0">
								<div class="bg-gradient-primary border-radius-lg h-100">
									<img
										...
										class="position-absolute h-100 w-25 top-0 d-lg-block d-none"
										alt="waves" />
									<div
										class="position-relative d-flex align-items-center justify-content-center h-100">
										<img
											class="w-100 position-relative z-index-0 pt-4"
