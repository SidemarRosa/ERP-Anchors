              ...
              <div class="card card-plain mt-7">
                ...
                <div class="card-body">
                  <form role="form">
                    ...
                    <div class="text-center">
                      <button type="button" class="btn bg-gradient-info w-100 mt-4 mb-0"><a href="dashboard"> Entrar </a> </button>
                    </div>
                  </form>
                </div>
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    ...
                    <a href="cadastro" class="text-info text-gradient font-weight-bold">Cadastro</a>
                  </p>
                </div>
              </div>
            </div>
